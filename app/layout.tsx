...
export const metadata: Metadata = {
  ...
  keywords: 'dropit, file sharing, instant file sharing, effortless file sharing, no account needed, simple file sharing, quick file transfer, DropIT, code-based file sharing, fast file sharing, secure file sharing',
  authors: [{
    name: 'Aswanth V C',
